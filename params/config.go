...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		ChainID_ALT:             big.NewInt(4949), //10001
...
func (c *ChainConfig) String() string {
	...
	banner += "Rede hard forks:\n"
	banner += fmt.Sprintf(" - Homestead:                   %-8v (https://github.com/redeprojekt/redecoin-v3)\n", c.HomesteadBlock)
